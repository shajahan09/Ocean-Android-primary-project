...
public class Sales_Report_Summary_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        group_spinner =findViewById(R.id.salesReport_Group_spinner);
        customerName_spinner =findViewById(R.id.salesReport_customer_spinner);
        itemName_spinner =findViewById(R.id.salesReport_item_spinner);
